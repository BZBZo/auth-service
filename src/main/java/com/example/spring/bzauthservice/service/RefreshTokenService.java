...
public class RefreshTokenService {
    ...
    @Transactional
    public void saveTokenInfo(String email, String provider, String nickname, String refreshToken, String accessToken) {
        repository.save(new RefreshToken(email, provider, nickname, accessToken, refreshToken));
    }
